...
namespace cs221util {
  ...
  public:
    ...
    unsigned char a; /**< Alpha of the pixel, [0, 255]. */

    /**
     * Constructs a RGBAPixel.
     *
     * A default pixel is black.
     * Opaque implies that the alpha component of the pixel is 255.
     ...
     * @param alpha Alpha value for the new pixel, [0, 255].
     */
    RGBAPixel(int red=0, int green=0, int blue=0, int alpha=255);
